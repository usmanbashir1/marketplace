...
/**
 * Cminds DropshipNotification admin order view dropship dropshipped grid block.
 *
 * @category Cminds
 * @package  Cminds_DropshipNotification
 * @author   Piotr Pierzak <piotr@cminds.com>
 */
class Dropshipped extends Grid
{
    /**
     * @var Registry
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $collection
            ...
            ->filterByStatus(ModuleConfig::STATUS_COMPLETED);
    ...
    {
        return __('Dropshipped Order Items');
    }
}
