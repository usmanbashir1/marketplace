...
return [
    'modules' => [
        ...
        'Cminds_MarketplacePaypal' => 1,
        'Cminds_MarketplaceQa' => 1,
        'Cminds_MarketplaceRma' => 1,
        'Cminds_MultipleProductVendors' => 1,
        'Cminds_SupplierInventoryUpdate' => 1,
        'Cminds_SupplierRedirection' => 1,
        'Cminds_SupplierSubscription' => 1,
        'Cminds_DropshipNotification' => 1,
